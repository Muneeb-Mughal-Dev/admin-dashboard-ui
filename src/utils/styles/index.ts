...
export const getColor = async ({
    ...
    const colorClassName =
        (color || colors) === 'primary' && variant === 'solid' ?
        ...
        : (color || colors) === 'primary' && variant === 'outline' ?
        ...
        : (color || colors) === 'secondary' && variant === 'solid' ?
        ...
        : (color || colors) === 'secondary' && variant === 'outline' ?
        ...
        : (color || colors) === 'info' && variant === 'solid' ?
        ...
        : (color || colors) === 'info' && variant === 'outline' ?
        ...
        : (color || colors) === 'default' && variant === 'solid' ?
        ...
        : (color || colors) === 'default' && variant === 'outline' ?
        ...
        : (color || colors) === 'danger' && variant === 'solid' ?
        ...
        : (color || colors) === 'danger' && variant === 'outline' ?
        ...
        : (color || colors) === 'success' && variant === 'solid' ?
        ...
        : (color || colors) === 'success' && variant === 'outline' ?
        ...
        : (color || colors) === 'warning' && variant === 'solid' ?
        ...
        : (color || colors) === 'warning' && variant === 'outline' ?
